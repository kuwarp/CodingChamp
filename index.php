...
<!-- <link rel="stylesheet" href="./css/style.css"> -->
    ...
    <div class="container-fluid bg-danger text-banner"> <!-- Start Text Banner -->
        <div class="row bottom-banner">
          <div class="col-sm">
            <h5> <i class="fas fa-book-open text-white mr-3"></i> 100+ Online Courses</h5>
          </div>
          <div class="col-sm">
            <h5><i class="fas fa-users text-white mr-3"></i> Expert Instructors</h5>
          </div>
          <div class="col-sm">
            <h5><i class="fas fa-keyboard text-white mr-3"></i> Lifetime Access</h5>
          </div>
          <div class="col-sm">
            <h5><i class="fas fa-rupee-sign text-white mr-3"></i> Money Back Guarantee*</h5>
          </div>
        </div>
    </div> <!-- End Text Banner -->
    ...
    ?>  
     ...
     <!-- Start Students Testimonial -->
      <div class="container-fluid mt-5" style="background-color: black" id="Feedback">
