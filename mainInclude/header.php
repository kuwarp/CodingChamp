...
<html lang="en">
  <head>
    ...
    <title>CodingChamp</title>
  </head>
  <body>
     <!-- Start Nagigation -->
    <nav class="navbar navbar-expand-sm navbar-dark pl-5 fixed-top">
      <a href="index.php" class="navbar-brand">codingChamp</a>
      ...
      <div class="collapse navbar-collapse" id="myMenu">
        <ul class="navbar-nav custom-nav pl-5 ">
          ...
          ?> 
          <li class="nav-item custom-nav-item"><a href="#stufeedback.php" class="nav-link">Feedback</a></li>
